...
public class TracingDependencyProcessor implements DeploymentUnitProcessor {
  public static final ModuleIdentifier EXTENSION_MODULE = ModuleIdentifier.create("org.wildfly.extension.microprofile.opentracing-smallrye");
  ...
  private void addDependencies(DeploymentUnit deploymentUnit) {
    ...
    moduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, EXTENSION_MODULE, false, true, true, false));
