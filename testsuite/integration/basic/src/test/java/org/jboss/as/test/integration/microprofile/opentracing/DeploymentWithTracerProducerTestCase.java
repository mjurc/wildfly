...
import org.jboss.as.test.integration.microprofile.opentracing.application.MockTracerResolver;
...
public class DeploymentWithTracerProducerTestCase {
    ...
    public static Archive<?> deploy() {
        ...
        war.addClass(MockTracerResolver.class);
        war.addPackage(MockTracer.class.getPackage());
        war.addAsServiceProvider(TracerResolver.class, MockTracerResolver.class);
